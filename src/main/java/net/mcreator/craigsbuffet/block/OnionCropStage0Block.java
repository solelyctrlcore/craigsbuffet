...
public class OnionCropStage0Block extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:onion_crop_stage_0")
	public static final Block block = null;
	@ObjectHolder("craigs_buffet:onion_crop_stage_0")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public OnionCropStage0Block(CraigsBuffetModElements instance) {
		super(instance, 58);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("onion_crop_stage_0"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("onion_crop_stage_0");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(OnionSeedsItem.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(OnionSeedsItem.block));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("onion_crop_stage_0");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Onions");
		}
