...
public class OnionCropStage1Block extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:onion_crop_stage_1")
	public static final Block block = null;
	@ObjectHolder("craigs_buffet:onion_crop_stage_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public OnionCropStage1Block(CraigsBuffetModElements instance) {
		super(instance, 59);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("onion_crop_stage_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("onion_crop_stage_1");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("onion_crop_stage_1");
		}
