...
public class RedOnionCropStage2FinalBlock extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:red_onion_crop_stage_2_final")
	public static final Block block = null;
	@ObjectHolder("craigs_buffet:red_onion_crop_stage_2_final")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public RedOnionCropStage2FinalBlock(CraigsBuffetModElements instance) {
		super(instance, 73);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("red_onion_crop_stage_2_final"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_onion_crop_stage_2_final");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("red_onion_crop_stage_2_final");
		}
