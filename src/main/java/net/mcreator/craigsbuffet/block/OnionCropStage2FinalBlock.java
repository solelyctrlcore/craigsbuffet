...
public class OnionCropStage2FinalBlock extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:onion_crop_stage_2_final")
	public static final Block block = null;
	@ObjectHolder("craigs_buffet:onion_crop_stage_2_final")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public OnionCropStage2FinalBlock(CraigsBuffetModElements instance) {
		super(instance, 60);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("onion_crop_stage_2_final"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("onion_crop_stage_2_final");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("onion_crop_stage_2_final");
		}
