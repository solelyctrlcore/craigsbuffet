...
public class RedOnionCropStage0Block extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:red_onion_crop_stage_0")
	public static final Block block = null;
	@ObjectHolder("craigs_buffet:red_onion_crop_stage_0")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public RedOnionCropStage0Block(CraigsBuffetModElements instance) {
		super(instance, 71);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("red_onion_crop_stage_0"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_onion_crop_stage_0");
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(RedOnionSeedsItem.block);
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedOnionSeedsItem.block));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("red_onion_crop_stage_0");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Red Onions");
		}
