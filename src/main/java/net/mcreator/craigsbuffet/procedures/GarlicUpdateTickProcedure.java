...
import net.mcreator.craigsbuffet.block.GarlicCropStage2FinalBlock;
import net.mcreator.craigsbuffet.block.GarlicCropStage1Block;
import net.mcreator.craigsbuffet.block.GarlicCropStage0Block;
import net.mcreator.craigsbuffet.CraigsBuffetMod;

import java.util.Map;

public class GarlicUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency world for procedure GarlicUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency x for procedure GarlicUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency y for procedure GarlicUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency z for procedure GarlicUpdateTick!");
			return;
		}
		...
		stage1 = GarlicCropStage1Block.block.getDefaultState();
		stage2 = GarlicCropStage2FinalBlock.block.getDefaultState();
		if (new Object() {
