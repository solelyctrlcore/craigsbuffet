...
import net.mcreator.craigsbuffet.block.BlackberryStage2FinalBlock;
import net.mcreator.craigsbuffet.block.BlackberryCropStage1Block;
import net.mcreator.craigsbuffet.block.BlackberryCropStage0Block;
import net.mcreator.craigsbuffet.CraigsBuffetMod;

import java.util.Map;

public class BlackberryUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency world for procedure BlackberryUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency x for procedure BlackberryUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency y for procedure BlackberryUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency z for procedure BlackberryUpdateTick!");
			return;
		}
		...
		stage1 = BlackberryCropStage1Block.block.getDefaultState();
		stage2 = BlackberryStage2FinalBlock.block.getDefaultState();
		if (new Object() {
