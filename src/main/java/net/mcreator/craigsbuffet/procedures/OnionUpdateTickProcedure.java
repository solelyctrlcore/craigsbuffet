...
import net.mcreator.craigsbuffet.block.OnionCropStage2FinalBlock;
import net.mcreator.craigsbuffet.block.OnionCropStage1Block;
import net.mcreator.craigsbuffet.block.OnionCropStage0Block;
import net.mcreator.craigsbuffet.CraigsBuffetMod;

import java.util.Map;

public class OnionUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency world for procedure OnionUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency x for procedure OnionUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency y for procedure OnionUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency z for procedure OnionUpdateTick!");
			return;
		}
		...
		stage0 = OnionCropStage0Block.block.getDefaultState();
		stage1 = OnionCropStage1Block.block.getDefaultState();
		stage2 = OnionCropStage2FinalBlock.block.getDefaultState();
		if (new Object() {
