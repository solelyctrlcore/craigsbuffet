...
import net.mcreator.craigsbuffet.block.BlueberryCropStage2FinalBlock;
import net.mcreator.craigsbuffet.block.BlueberryCropStage1Block;
import net.mcreator.craigsbuffet.block.BlueberryCropStage0Block;
import net.mcreator.craigsbuffet.CraigsBuffetMod;

import java.util.Map;

public class BlueberryUpdateTickProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency world for procedure BlueberryUpdateTick!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency x for procedure BlueberryUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency y for procedure BlueberryUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CraigsBuffetMod.LOGGER.warn("Failed to load dependency z for procedure BlueberryUpdateTick!");
			return;
		}
		...
		stage1 = BlueberryCropStage1Block.block.getDefaultState();
		stage2 = BlueberryCropStage2FinalBlock.block.getDefaultState();
		if (new Object() {
