...
public class StrawberryItem extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:strawberry")
	public static final Item block = null;

	public StrawberryItem(CraigsBuffetModElements instance) {
		super(instance, 2);
	}
