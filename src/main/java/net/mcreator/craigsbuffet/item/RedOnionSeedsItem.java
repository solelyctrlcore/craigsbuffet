...
public class RedOnionSeedsItem extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:red_onion_seeds")
	public static final Item block = null;

	public RedOnionSeedsItem(CraigsBuffetModElements instance) {
		super(instance, 65);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("red_onion_seeds");
		}
