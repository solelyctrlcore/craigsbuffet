...
public class BlueberriesItem extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:blueberries")
	public static final Item block = null;

	public BlueberriesItem(CraigsBuffetModElements instance) {
		super(instance, 3);
	}
