...
public class OnionSeedsItem extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:onion_seeds")
	public static final Item block = null;

	public OnionSeedsItem(CraigsBuffetModElements instance) {
		super(instance, 63);
	}
