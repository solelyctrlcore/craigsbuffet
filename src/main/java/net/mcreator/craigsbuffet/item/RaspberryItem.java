...
public class RaspberryItem extends CraigsBuffetModElements.ModElement {
	@ObjectHolder("craigs_buffet:raspberry")
	public static final Item block = null;

	public RaspberryItem(CraigsBuffetModElements instance) {
		super(instance, 5);
	}
